...
echo "→ Build arm64..."
cmake -B build-arm64 -DCMAKE_OSX_ARCHITECTURES=arm64 -DWHISPER_NO_METAL=OFF -DCMAKE_BUILD_TYPE=Release
...
echo "→ Build x86_64..."
cmake -B build-x64 -DCMAKE_OSX_ARCHITECTURES=x86_64 -DCMAKE_BUILD_TYPE=Release
